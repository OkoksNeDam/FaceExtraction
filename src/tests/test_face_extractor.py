...
@pytest.fixture
def face_extractor():
    return FaceExtractor(face_part_classifier_filepath="../../downloaded_models/face_part_classifier.pickle")


def test_incorrect_extension(face_extractor):
    image_path = "../tests/test_images/incorrect_extension/test.txt"
...
def test_incorrect_resolution(face_extractor):
    image_path = "../tests/test_images/incorrect_resolution/1.jpg"
    model_output = face_extractor.extract_face_from(image_path)
